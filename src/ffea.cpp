...
int main(int argc, char *argv[])
{
    ...
    cout << "\tTeam:       Robert Chisholm, Ryan Cocking, Molly Gravett, Benjamin Hanson, Oliver Harlen, Sarah Harris," << endl;
    cout << "\t            Joanna Leng, Robin Oliver, Jonathan Pickering, Daniel Read, Robin Richardson, Ess Ridley," << endl;
    cout << "\t            Jarvellis Rogers, Albert Solernou, Robert Welch\n" << endl;
    cout << "\tEnquiries:  sarah.harris@sheffield.ac.uk" << endl;
    cout << endl;
